                        ...
                        @foreach ($program_schedule->exercises as $exercise)
                            <li class="mb-2">
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div class="content-center">
                                        <p><span class="bg-red-300 px-2 rounded">No.reps:
                                                {{ $exercise->no_of_reps }}</span>
                                        </p>
                                    </div>
                                    <div class="content-center">
                                        <p><span class="bg-red-300 px-2 rounded">No.sets:
                                                {{ $exercise->no_of_sets }}</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                        ...
                        <form action="/trainer/programs" id="ScheduleForm" name="ScheduleForm" method="POST">
                            @csrf
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-center justify-center p-4 text-center">
                    <div
                        ...
                        <div class="mt-4">
                            <form action="/trainer/programs/program/{{ $program->id }}/add_exercise" method="POST">
                                @csrf
                                <input type="hidden" name="program_schedule_id" id="program-schedule-id"
                                    value="">
