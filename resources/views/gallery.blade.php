    ...
    <div class="gallery">
                ...
                <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 max-w-7xl mx-auto px-4">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                        <img src="https://as1.ftcdn.net/v2/jpg/02/64/23/78/1000_F_264237813_6Yn9JJkBZkuGP9gEgebCA5xVqhqz76v3.jpg"
                            alt="Training Image 1" class="w-full h-96 object-cover">
                        <div class="p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                        <img src="https://www.mmagyms.net/wp-content/uploads/2020/01/Personal-Trainer-Packages.png"
                            alt="Training Image 2" class="w-full h-96 object-cover">
                        <div class="p-6">
        ...
        <section id="vids" class="py-10 bg-gray-100">
            ...
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto px-4">
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Chest Workout" class="w-full h-48 object-cover">
                    <div class="p-4">
                        <h3 class="font-semibold text-lg">Chest Workout</h3>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Back Workout" class="w-full h-48 object-cover">
                    <div class="p-4">
                        <h3 class="font-semibold text-lg">Back Workout</h3>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Arms Workout" class="w-full h-48 object-cover">
                    <div class="p-4">
                        <h3 class="font-semibold text-lg">Arms Workout</h3>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Abdominal Workout"
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Legs Workout" class="w-full h-48 object-cover">
                    <div class="p-4">
                        <h3 class="font-semibold text-lg">Legs Workout</h3>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden card fade-in">
                    <img src="https://via.placeholder.com/400x200" alt="Shoulders Workout"
                        class="w-full h-48 object-cover">
                    <div class="p-4">
        ...
        <section id="divider" class="py-10"
            style="background: linear-gradient(to right, rgba(0, 0, 0, 0.8), rgba(255, 0, 0, 0.8));">
        ...
        <section id="Our Story" class="py-0 bg-white mb-0">
            <div class="w-full relative">
                <div class="relative bg-cover bg-center"
                    style="background-image: url('https://d296qbqev3kq48.cloudfront.net/wp-content/uploads/2018/02/14202150/shutterstock_559177615.jpg'); min-height: 80vh; height: 100%;">
