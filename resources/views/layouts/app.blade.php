                                    ...
                                    <a href="#"
                                        ...
                                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M2.25 12L11.25 3l8.954 8.954M4.5 21V10.5h15V21H4.5Z" />
                                        </svg>
                                        Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="#"
                                        ...
                                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M12 6.375A3.375 3.375 0 1 0 12 13.125M4.5 21v-7.5h15V21H4.5Z" />
                                        </svg>
                                        Team
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="#"
                                        ...
                                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M9.75 3.75v16.5M14.25 3.75v16.5" />
                                        </svg>
                                        Calendar
                                    </a>
                                </li>
                            ...
                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                ...
                                <li>
                                    <a href="#"
                                        ...
                                        <span class="truncate">Trainers</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
