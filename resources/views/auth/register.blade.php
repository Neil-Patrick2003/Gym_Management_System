        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name"
                    class="block mt-1 w-full px-4 py-2 bg-transparent border-2 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-nuetral-100 focus:border-red-500 text-white"
            ...
            <div class="mb-4">
                ...
                <x-text-input id="email"
                    class="block mt-1 w-full px-4 py-2 bg-transparent border-2 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-white"
            ...
            <!-- Form Footer with Link and Button -->
